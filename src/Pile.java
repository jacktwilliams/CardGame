 ...
 * Due Date: 02/05/2018
 * Pile is a generic class that implements a linked list. I plan to use it to simulate a deck of cards.
 */

public class Pile<AnyType extends Comparable<AnyType>> implements MySimpleList<AnyType> {
	...
	static class Node<AnyType> {
		...
		private Node(AnyType obj, Node<AnyType> next) {
			object = obj;
			this.next = next;
		}
	}
